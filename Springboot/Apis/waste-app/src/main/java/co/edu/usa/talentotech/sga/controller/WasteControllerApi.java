...
public interface WasteControllerApi {
 ...
 @ApiResponses(value = { 
    ...
    @GetMapping("/filter")
    public MultipleResponse getFilteredWaste(@RequestParam int year, @RequestParam int month, 
    		@RequestParam String classification, @RequestParam String type) throws ResponseDetails;
