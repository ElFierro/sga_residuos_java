...
// *** 200 *****//
	...
	public static final String ERROR_CITY_REQUIRED="La ciudad es requerida.";
	...
	public static final String ERROR_VALID_ROUTES = "Esta ruta no existe.";
	public static final String ERROR_VALID_CLASSIFICATION_WASTE = "La clasificacion seleccionada no es valida.";
	public static final String ERROR_VALID_TYPE_WASTE = "Este tipo de residuo no es valido.";
	...
	public static final String ERROR_ROUTE_REQUIRED = "Especificar la ruta es obligatoria.";
